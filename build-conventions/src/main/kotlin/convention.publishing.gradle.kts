...
val isMainHost =
    HostManager.simpleOsName().equals("${project.findProperty("project.mainOS")}", true)
...
publishing {
    publications {
        ...
        val ghOwnerOrganizationUrl: String =
            project.findProperty("gh.owner.organization.url")!!.toString()
